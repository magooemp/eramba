			...
			<?php foreach ( $data as $entry ) : ?>
				<div class="widget box widget-closed">
					<div class="widget-header">
						<h4><?php echo __( 'Business Unit' ); ?>: <?php echo $entry['BusinessUnit']['name']; ?></h4>
							...
							<?php foreach ( $entry['BusinessContinuity'] as $risk ) : ?>
								...
								<div class="widget box widget-closed">
									<div class="widget-header <?php echo $extra_class; ?>">
										<h4><?php echo __( 'Business Continuity' ); ?>: <?php echo $risk['title']; ?></h4>
										<div class="toolbar no-padding">
											<div class="btn-group">
												<span class="btn btn-xs widget-collapse"><i class="icon-angle-up"></i></span>
									...
									<div class="widget-content" style="display:none;">
										...
										<div class="widget box widget-closed">
											<div class="widget-header">
												<h4><?php echo __( 'Applicable Business Unit' ); ?></h4>
												<div class="toolbar no-padding">
													<div class="btn-group">
														<span class="btn btn-xs widget-collapse"><i class="icon-angle-up"></i></span>
													</div>
											...
											<div class="widget-content" style="display:none;">
												<?php if ( ! empty( $risk['BusinessUnit'] ) ) : ?>
												<table class="table table-hover table-striped table-bordered table-highlight-head">
													<thead>
														<tr>
															<th><?php echo __( 'Name' ); ?></th>
															<th><?php echo __( 'Description' ); ?></th>
															<th><?php echo __( 'Minimum RTO' ); ?></th>
															<th><?php echo __( 'Minimum RPO' ); ?></th>
															<th><?php echo __( 'Generates Revenue?' ); ?></th>
														</tr>
													</thead>
													<tbody>
														<?php foreach ( $risk['BusinessUnit'] as $bu ) : ?>
														<?php
														foreach ( $bu['Process'] as $process ) {
															if ( ( ! isset( $rto ) ) || ( isset( $rto ) && $rto > $process['rto'] ) ) {
																$rto = $process['rto'];
															}
															if ( ( ! isset( $rpo ) ) || ( isset( $rpo ) && $rpo > $process['rpo'] ) ) {
																$rpo = $process['rpo'];
															}
														}
														?>
														<tr>
															<td><?php echo $bu['BusinessUnit']['name']; ?></td>
															<td><?php echo $bu['BusinessUnit']['description']; ?></td>
															<td><?php echo isset( $rto ) ? $rto : ''; ?></td>
															<td><?php echo isset( $rpo ) ? $rpo : ''; ?></td>
															<td><?php echo $bu['BusinessUnit']['revenue'] ? __( 'Yes' ) : __( 'No' ); ?></td>
														</tr>
														<?php endforeach; ?>
													</tbody>
												</table>
										...
										<table class="table table-hover table-striped table-bordered table-highlight-head">
											<thead>
												<tr>
													<th><?php echo __( 'Business Impact' ); ?></th>
												</tr>
											</thead>
											<tbody>
												<tr>
