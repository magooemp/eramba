			...
			<div class="widget-content">
				...
				<div class="form-group">
					...
					<div class="col-md-10">
						<?php
							...
							if ( isset( $this->request->data['Risk']['asset_id'] ) && is_array( $this->request->data['Risk']['asset_id'] ) ) {
				...
				<div class="form-group">
					...
					<div class="col-md-10">
						<?php
							...
							if ( isset( $this->request->data['Risk']['threat_id'] ) && is_array( $this->request->data['Risk']['threat_id'] ) ) {
				...
				<div class="form-group">
					...
					<div class="col-md-10">
						<?php
							...
							if ( isset( $this->request->data['Risk']['vulnerability_id'] ) && is_array( $this->request->data['Risk']['vulnerability_id'] ) ) {
				...
				<div class="form-group">
					...
					<div class="col-md-10">
						...
						/*$sum = 0;
						if ( isset( $this->request->data['RiskClassification'] ) ) {
							foreach ( $this->request->data['RiskClassification'] as $risk_classification ) {
								$sum += $risk_classification['value'];
							}
						}*/
						?>
				...
				<div class="form-group">
					...
					<div class="col-md-10">
						<?php
							...
							if ( isset( $this->request->data['Risk']['security_service_id'] ) && is_array( $this->request->data['Risk']['security_service_id'] ) ) {
				...
				<div class="form-group">
					...
					<div class="col-md-10">
						<?php
							...
							if ( isset( $this->request->data['Risk']['risk_exception_id'] ) && is_array( $this->request->data['Risk']['risk_exception_id'] ) ) {
