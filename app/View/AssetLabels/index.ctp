		...
		<div class="widget">
			<?php if ( ! empty( $data ) ) : ?>
				<table class="table table-hover table-striped table-bordered table-highlight-head">
					<thead>
						<tr>
							<th><?php echo $this->Paginator->sort( 'AssetLabel.name', __( 'Name' ) ); ?></th>
							<th><?php echo $this->Paginator->sort( 'AssetLabel.description', __( 'Description' ) ); ?></th>
					...
					<tbody>
						<?php foreach ( $data as $entry ) : ?>
							<tr>
								...
								<td><?php echo $entry['AssetLabel']['description']; ?></td>
